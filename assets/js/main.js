...
const acronym = [
  ...
  { letter: 'X', meaning: 'eXcellence' } // or eXcellence eXperiments
];
...
//				  <div class="meaning"><strong>${item.letter}</strong> &mdash; ${item.meaning}</div>`; old working
  list.appendChild(li);
});

// Animate brand letters
